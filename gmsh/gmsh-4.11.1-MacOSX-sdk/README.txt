This is the binary Software Development Kit (SDK) for Gmsh 4.11.1:

  * Operating system: MacOSX-sdk (Darwin)
  * C++ compiler: /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/c++
  * C++ compiler ID: AppleClang
  * C++ compiler version: 11.0.3
  * C++ compiler flags: -Xclang -fopenmp -O2 -g -DNDEBUG
